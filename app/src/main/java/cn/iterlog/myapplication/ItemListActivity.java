            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (holder.mItem.id.equals("1")) {
                        ...
                        startActivity(new Intent(ItemListActivity.this, TranActivity0.class));
                    } else if (holder.mItem.id.equals("3")) {
                        startActivity(new Intent(ItemListActivity.this, WidgetActivity.class));
                    } else if (holder.mItem.id.equals("4")) {
                        startActivity(new Intent(ItemListActivity.this, ViewActivity.class));
                    } else if (holder.mItem.id.equals("5")) {
                        startActivity(new Intent(ItemListActivity.this, NotificationActivity.class));
                    }  else if (holder.mItem.id.equals("6")) {
